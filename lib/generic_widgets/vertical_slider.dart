...
class _VerticalSliderState extends State<VerticalSlider> with TickerProviderStateMixin {
...
class _RenderSlider extends RenderBox {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    // : Move this to paint after the thumb.
    ...
    if (isDiscrete) {
      // : Align tick mark centers to ends of track by not subtracting diameter from length.
