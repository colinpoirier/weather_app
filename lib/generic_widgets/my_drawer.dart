...
// (eseidel): Draw width should vary based on device size:
...
/// opened or closed.
typedef MyDrawerCallback = void Function(bool isOpened);
...
class MyDrawerControllerState extends State<DrawerController> with SingleTickerProviderStateMixin {
  @override
  void initState() {
    super.initState();
  ...
  final ColorTween _color = ColorTween(begin: Colors.transparent, end: Colors.transparent);
