...
class _TypeAheadFieldState<T> extends State<TypeAheadField<T>>
  ...
  void setFocus() async{
    ...
    if(_context != null){
      FocusScope.of(context).requestFocus(this._effectiveFocusNode);
      }
    //await Future.delayed(Duration(milliseconds: 500), ()=>FocusScope.of(_context).requestFocus(this._effectiveFocusNode));}
  }
